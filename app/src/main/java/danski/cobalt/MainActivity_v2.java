...
import danski.cobalt.Adaptor.Adapter_MainActivity;
import danski.cobalt.Data.Match;
import danski.cobalt.PreferencesActivity.PreferencesActivity;
import danski.cobalt.StatsActivity.TabbedStatsActivity;
...
public class MainActivity_v2 extends ActionBarActivity{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            startActivity(new Intent(Defines.CurrentContext, PreferencesActivity.class));
            return true;
        }
